...
// Components
import FirstFormRow from "./components/FirstFormRow";
import SecondFormRow from "./components/SecondFormRow";
import ThirdFormRow from "./components/ThirdFormRow";
import FourthFormRow from "./components/FourthFormRow";
...
const Main = () => {
    ...
    // Hook State Data
    const [alerts, setAlerts] = useState({fullName: "", nim: "", interest: "", email: "", departments: ""})
    ...
    useEffect(() => {
        axios.get("https://pemrograman.me/api/v1/departments").then(res => {
            let tempData = [];
            res.data.data.forEach((val, idx, arr) => {
        ...
        <div className="Main">
            ...
            <div className="Section-1">
                ...
                <div className="Box-Form">
                    ...
                    <FirstFormRow fullName={fullName} setFullName={setFullName} alerts={alerts} setAlerts={setAlerts} gender={gender} setGender={setGender}/>

                    <SecondFormRow nim={nim} setNim={setNim} interest={interest} setInterest={setInterest} alerts={alerts} setAlerts={setAlerts} interestData={interestData}/>

                    <ThirdFormRow email={email} setEmail={setEmail} departmentsData={departmentsData} isLoadingData={isLoadingData} department={department} setDepartment={setDepartment} alerts={alerts} setAlerts={setAlerts} />
                ...
                <div className="button">
                    <div className="Ready-Btn">I'M READY</div>
                </div>
            </div>
        </div>
    )
